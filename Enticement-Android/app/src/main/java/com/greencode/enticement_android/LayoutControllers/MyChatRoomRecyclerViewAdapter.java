...
import com.greencode.enticement_android.ViewFragments.ListChatroomFragment.OnListFragmentInteractionListener;
...
public class MyChatRoomRecyclerViewAdapter extends RecyclerView.Adapter<MyChatRoomRecyclerViewAdapter.ViewHolder> {
    ...
    public MyChatRoomRecyclerViewAdapter(List<DummyContent.DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
