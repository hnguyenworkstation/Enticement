...
import com.greencode.enticement_android.ViewFragments.UpdatesFragment.OnListFragmentInteractionListener;
...
public class MyUpdatesRecyclerViewAdapter extends RecyclerView.Adapter<MyUpdatesRecyclerViewAdapter.ViewHolder> {
    ...
    private final UpdatesFragment.OnListFragmentInteractionListener mListener;

    public MyUpdatesRecyclerViewAdapter(List<DummyContent.DummyItem> items, UpdatesFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
