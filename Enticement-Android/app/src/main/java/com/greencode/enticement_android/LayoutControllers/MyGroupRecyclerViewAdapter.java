...
public class MyGroupRecyclerViewAdapter extends RecyclerView.Adapter<MyGroupRecyclerViewAdapter.ViewHolder> {
    ...
    private final GroupAroundFragment.OnListFragmentInteractionListener mListener;

    public MyGroupRecyclerViewAdapter(List<DummyContent.DummyItem> items, GroupAroundFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
